...
L["Class icon portraits"] = "Классовая иконка портретов"
L["Classic"] = "Классик"
...
L["If checked, chat text will not fade out after a time period."] = "Если флажок установлен, то текст чата не будет исчезать спустя время."
L["If checked, class coloring will be used in the player frame and target frame."] = "Если флажок установлен, то цвет по классам будет не только на фрейме игрока, но и на цели."
...
L["If checked, class icons will be shown in the portrait frames."] = "Если флажок установлен, в фреймах с портретами будут отображаться значки классов."
...
L["If checked, group invites will only be sent to friends and guild members.|n|nIf unchecked, group invites will be sent to everyone."] = "Если флажок установлен, групповые приглашения будут отправляться только друзьям и членам гильдии.|n|nЕсли флажок снят, групповые приглашения будут отправляться всем."
