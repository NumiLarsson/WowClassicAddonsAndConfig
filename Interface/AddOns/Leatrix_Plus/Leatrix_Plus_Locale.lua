...
L["Enhance professions"] = "Повысить профессии"
...
L["If checked, a bag search box will be shown in the backpack frame and the bank frame."] = "Если этот флажок установлен, в рюкзаке и банке будет отображаться строка поиска в сумке."
...
L["If checked, group invites will only be sent to friends and guild members.|n|nIf unchecked, group invites will be sent to everyone."] = "Если этот флажок установлен, групповые приглашения будут отправляться только друзьям и членам гильдии.|n|nЕсли флажок снят, групповые приглашения будут отправляться всем."
...
L["If checked, helm and cloak toggle checkboxes will be shown in the character sheet.|n|nYou can hold shift and right-click the checkboxes to switch layouts."] = "Если установлен этот флажок, флажки переключения головы и плаща будут отображаться на листе символов.|n|nВы можете удерживать клавишу shift и щелкнуть правой кнопкой мыши по флажкам, чтобы переключить раскладки."
...
L["If checked, the number of free bag slots will be shown in the backpack button icon and tooltip."] = "Если этот флажок установлен, количество свободных мест в сумке будет отображаться в значке кнопки рюкзака и во всплывающей подсказке."
L["If checked, the per unit vendor price will be shown in item tooltips."] = "Если этот флажок установлен, цена за единицу у торговца будет отображаться во всплывающих подсказках."
...
L["If checked, the professions frame will be larger."] = "Если флажок установлен, окно профессий будет больше."
L["If checked, the quest log frame will be larger and feature a world map button and quest levels."] = "Если флажок установлен, рамка журнала заданий будет больше и будет содержать кнопку карты мира и уровни заданий."
...
L["If checked, the target frame background will be shown in class color."] = "Если этот флажок установлен, фон целевого окна будет отображаться в цвете класса."
...
L["If checked, you will be able to change the font size of book text."] = "Если установлен этот флажок, вы сможете изменить размер шрифта текста книги."
