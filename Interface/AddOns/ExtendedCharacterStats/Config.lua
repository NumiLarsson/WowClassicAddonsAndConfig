...
local function Config()
    ECSSettingsWindow:SetShown(not ECSSettingsWindow:IsShown())
end
...
function CreateRangedOptions()
        ...
        ShowRangedHit:SetScript("OnClick", 
        function() 
        ...
        ShowRangedCrit:SetScript("OnClick", 
        function() 
        ...
        ShowRangedCrit:SetScript("OnUpdate", 
        function() 
...
function CreateMeleeOptions()
    ...
    -- Create Header Options
        ...
        ShowMeleeHit:SetScript("OnClick", 
        function() 
        ...
        ShowMeleeCrit:SetScript("OnClick", 
        function() 
...
function CreateSpellOptions()
   ...
   -- Create Header Options
        ...
        ShowSpellHit:SetScript("OnClick", 
        function() 
        ...
        ShowSpellCrit:SetScript("OnClick", 
        function() 
...
function CreateRegenOptions()
    ...
    ShowRegenCasting:SetScript("OnClick", 
    function() 
    ...
    ShowRegenCasting:SetScript("OnUpdate", 
    function() 
    ...
    ShowRegenNotCasting:SetScript("OnClick", 
    function() 
    ...
    ShowRegenNotCasting:SetScript("OnUpdate", 
    function() 
    ...
    ShowCurrentRegen:SetScript("OnClick", 
    function() 
    ...
    ShowCurrentRegen:SetScript("OnUpdate", 
    function() 
...
function CreateSpellBonusOptions()
    ...
    ShowSpellBonus:SetScript("OnClick", 
    function() 
    ...
    ShowSpellBonus:SetScript("OnUpdate", 
    function() 
    ...
    ShowPhysicalDmg:SetScript("OnClick", 
    function() 
        ExtendedCharacterStats.Profile.SpellBonus.PhysicalDmg.Display = not ExtendedCharacterStats.Profile.SpellBonus.PhysicalDmg.Display;
        local show = ExtendedCharacterStats.Profile.SpellBonus.PhysicalDmg.Display;
        ShowPhysicalDmg:SetChecked(show)
    end)

    ShowPhysicalDmg:SetScript("OnUpdate", 
    function() 
    ...
    ShowPhysicalCrit:SetScript("OnClick", 
    function() 
        ExtendedCharacterStats.Profile.SpellBonus.PhysicalCrit.Display = not ExtendedCharacterStats.Profile.SpellBonus.PhysicalCrit.Display;
        local show = ExtendedCharacterStats.Profile.SpellBonus.PhysicalCrit.Display;
        ShowPhysicalCrit:SetChecked(show)
    end)

    ShowPhysicalCrit:SetScript("OnUpdate", 
    function() 
    ...
    ShowArcaneDmg:SetScript("OnClick", 
    function() 
        ExtendedCharacterStats.Profile.SpellBonus.ArcaneDmg.Display = not ExtendedCharacterStats.Profile.SpellBonus.ArcaneDmg.Display;
        local show = ExtendedCharacterStats.Profile.SpellBonus.ArcaneDmg.Display;
        ShowArcaneDmg:SetChecked(show)
    end)

    ShowArcaneDmg:SetScript("OnUpdate", 
    function() 
    ...
    ShowArcaneCrit:SetScript("OnClick", 
    function() 
        ExtendedCharacterStats.Profile.SpellBonus.ArcaneCrit.Display = not ExtendedCharacterStats.Profile.SpellBonus.ArcaneCrit.Display;
        local show = ExtendedCharacterStats.Profile.SpellBonus.ArcaneCrit.Display;
        ShowArcaneCrit:SetChecked(show)
    end)

    ShowArcaneCrit:SetScript("OnUpdate", 
    function() 
    ...
    ShowNatureDmg:SetScript("OnClick", 
    function() 
        ExtendedCharacterStats.Profile.SpellBonus.NatureDmg.Display = not ExtendedCharacterStats.Profile.SpellBonus.NatureDmg.Display;
        local show = ExtendedCharacterStats.Profile.SpellBonus.NatureDmg.Display;
        ShowNatureDmg:SetChecked(show)
    end)

    ShowNatureDmg:SetScript("OnUpdate", 
    function() 
    ...
    ShowNatureCrit:SetScript("OnClick", 
    function() 
        ExtendedCharacterStats.Profile.SpellBonus.NatureCrit.Display = not ExtendedCharacterStats.Profile.SpellBonus.NatureCrit.Display;
        local show = ExtendedCharacterStats.Profile.SpellBonus.NatureCrit.Display;
        ShowNatureCrit:SetChecked(show)
    end)

    ShowNatureCrit:SetScript("OnUpdate", 
    function() 
    ...
    ShowHolyDmg:SetScript("OnClick", 
    function() 
        ExtendedCharacterStats.Profile.SpellBonus.HolyDmg.Display = not ExtendedCharacterStats.Profile.SpellBonus.HolyDmg.Display;
        local show = ExtendedCharacterStats.Profile.SpellBonus.HolyDmg.Display;
        ShowHolyDmg:SetChecked(show)
    end)

    ShowHolyDmg:SetScript("OnUpdate", 
    function() 
    ...
    ShowHolyCrit:SetScript("OnClick", 
    function() 
        ExtendedCharacterStats.Profile.SpellBonus.HolyCrit.Display = not ExtendedCharacterStats.Profile.SpellBonus.HolyCrit.Display;
        local show = ExtendedCharacterStats.Profile.SpellBonus.HolyCrit.Display;
        ShowHolyCrit:SetChecked(show)
    end)

    ShowHolyCrit:SetScript("OnUpdate", 
    function() 
    ...
    ShowFrostDmg:SetScript("OnClick", 
    function() 
        ExtendedCharacterStats.Profile.SpellBonus.FrostDmg.Display = not ExtendedCharacterStats.Profile.SpellBonus.FrostDmg.Display;
        local show = ExtendedCharacterStats.Profile.SpellBonus.FrostDmg.Display;
        ShowFrostDmg:SetChecked(show)
    end)

    ShowFrostDmg:SetScript("OnUpdate", 
    function() 
    ...
    ShowFrostCrit:SetScript("OnClick", 
    function() 
        ExtendedCharacterStats.Profile.SpellBonus.FrostCrit.Display = not ExtendedCharacterStats.Profile.SpellBonus.FrostCrit.Display;
        local show = ExtendedCharacterStats.Profile.SpellBonus.FrostCrit.Display;
        ShowFrostCrit:SetChecked(show)
    end)

    ShowFrostCrit:SetScript("OnUpdate", 
    function() 
    ...
    ShowFireDmg:SetScript("OnClick", 
    function() 
        ExtendedCharacterStats.Profile.SpellBonus.FireDmg.Display = not ExtendedCharacterStats.Profile.SpellBonus.FireDmg.Display;
        local show = ExtendedCharacterStats.Profile.SpellBonus.FireDmg.Display;
        ShowFireDmg:SetChecked(show)
    end)

    ShowFireDmg:SetScript("OnUpdate", 
    function() 
    ...
    ShowFireCrit:SetScript("OnClick", 
    function() 
        ExtendedCharacterStats.Profile.SpellBonus.FireCrit.Display = not ExtendedCharacterStats.Profile.SpellBonus.FireCrit.Display;
        local show = ExtendedCharacterStats.Profile.SpellBonus.FireCrit.Display;
        ShowFireCrit:SetChecked(show)
    end)

    ShowFireCrit:SetScript("OnUpdate", 
    function() 
    ...
    ShowShadowDmg:SetScript("OnClick", 
    function() 
        ExtendedCharacterStats.Profile.SpellBonus.ShadowDmg.Display = not ExtendedCharacterStats.Profile.SpellBonus.ShadowDmg.Display;
        local show = ExtendedCharacterStats.Profile.SpellBonus.ShadowDmg.Display;
        ShowShadowDmg:SetChecked(show)
    end)

    ShowShadowDmg:SetScript("OnUpdate", 
    function() 
    ...
    ShowShadowCrit:SetScript("OnClick", 
    function() 
        ExtendedCharacterStats.Profile.SpellBonus.ShadowCrit.Display = not ExtendedCharacterStats.Profile.SpellBonus.ShadowCrit.Display;
        local show = ExtendedCharacterStats.Profile.SpellBonus.ShadowCrit.Display;
        ShowShadowCrit:SetChecked(show)
    end)

    ShowShadowCrit:SetScript("OnUpdate", 
    function() 
	...
	ShowBonusHealing:SetScript("OnClick", 
	function() 
		ExtendedCharacterStats.Profile.SpellBonus.BonusHealing.Display = not ExtendedCharacterStats.Profile.SpellBonus.BonusHealing.Display;
		local show = ExtendedCharacterStats.Profile.SpellBonus.BonusHealing.Display;
		ShowBonusHealing:SetChecked(show)
	end)

	ShowBonusHealing:SetScript("OnUpdate", 
	function() 
...
function ECSConfig:CreateWindow()
    ...
    ECSMainWindow:SetPoint("RIGHT", PaperDollItemsFrame, "RIGHT", ExtendedCharacterStats.WindowSize.xOffset, ExtendedCharacterStats.WindowSize.yOffset) -- Point, relativeFrame, relativePoint, xOffset, yOffset
